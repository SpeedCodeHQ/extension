...
export interface TestCase { input: any[], expected: any };
export interface TestResult extends TestCase { result: any, valid: boolean };

export default function testCode(code: string, testCases: TestCase[]): [boolean, TestResult[]] {
